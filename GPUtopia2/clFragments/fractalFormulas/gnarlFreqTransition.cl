...
//=========| fractal formula loop
            complex v1x = (w * @Weight1) * stream_func_gradient_X1(@Freq1 * z.x, @Freq1 * z.y);
            complex v1y = (w * @Weight1) * stream_func_gradient_Y1(@Freq1 * z.x, @Freq1 * z.y);
            complex v2x = (((real)1. - w) * @Weight2) * stream_func_gradient_X1(@Freq2 * z.x, @Freq2 * z.y);
            complex v2y = (((real)1. - w) * @Weight2) * stream_func_gradient_Y1(@Freq2 * z.x, @Freq2 * z.y);
