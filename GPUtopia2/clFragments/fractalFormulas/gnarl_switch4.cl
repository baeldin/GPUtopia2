...
//=========| fractal formula loop
        if (@Type1 == 0)
            z += @c1 * RK4_square(@f1 * z, @c1);
        else if (@Type1 == 1)
            z += @c1 * RK4_tri(@f1 * z, @c1);
        else if (@Type1 == 2)
            z += @c1 * RK4_pent(@f1 * z, @c1);
        if (@Type2 == 0)
            z += @c2 * RK4_square(@f2 * z, @c2);
        else if (@Type2 == 1)
            z += @c2 * RK4_tri(@f2 * z, @c2);
        else if (@Type2 == 2)
            z += @c2 * RK4_pent(@f2 * z, @c2);
        if (@Type3 == 0)
            z += @c3 * RK4_square(@f3 * z, @c3);
        else if (@Type3 == 1)
            z += @c3 * RK4_tri(@f3 * z, @c3);
        else if (@Type3 == 2)
            z += @c3 * RK4_pent(@f3 * z, @c3);
__bailout:
...
// PENTARL CONSTANTS
__constant real Pa1 = 0.30901699437494742410229341718281905886015458990288143106772431135263023140;
__constant real Pa2 = -0.8090169943749474241022934171828190588601545899028814310677243113526302314;
__constant real Pb1 = 0.95105651629515357211643933337938214340569863412575022244730564443015317008;
__constant real Pb2 = 0.58778525229247312916870595463907276859765243764314599107227248075727847416;
