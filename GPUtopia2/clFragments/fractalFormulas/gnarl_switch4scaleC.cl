...
//=========| fractal formula loop
        if (@numericalMethod == 0)
        {
            if (@Type1 == 0)
                ...
                z += @scale * @c1 * MP_tri(@f1 * z, @scale * @c1);
            else if (@Type1 == 2)
                z += @scale * @c1 * MP_pent(@f1 * z, @scale * @c1);
            else if (@Type1 == 3)
                z += @scale * @c1 * MP_round(@f1 * z, @N1, @roundShift1, @scale * @c1);
            if (@Type2 == 0)
                z += @scale * @c2 * MP_square(@f2 * z, @scale * @c2);
            else if (@Type2 == 1)
                z += @scale * @c2 * MP_tri(@f2 * z, @scale * @c2);
            else if (@Type2 == 2)
                z += @scale * @c2 * MP_pent(@f2 * z, @scale * @c2);
            else if (@Type2 == 3)
                z += @scale * @c2 * MP_round(@f2 * z, @N2, @roundShift2, @scale * @c2);
            if (@Type3 == 0)
                z += @scale * @c3 * MP_square(@f3 * z, @scale * @c3);
            else if (@Type3 == 1)
                z += @scale * @c3 * MP_tri(@f3 * z, @scale * @c3);
            else if (@Type3 == 2)
                z += @scale * @c3 * MP_pent(@f3 * z, @scale * @c3);
            else if (@Type3 == 3)
                z += @scale * @c3 * MP_round(@f3 * z, @N3, @roundShift3, @scale * @c3);
        }
        else
        if (@numericalMethod == 1)
        {
            if (@Type1 == 0)
                z += @scale * @c1 * RK4_square(@f1 * z, @scale * @c1);
            else if (@Type1 == 1)
                z += @scale * @c1 * RK4_tri(@f1 * z, @scale * @c1);
            else if (@Type1 == 2)
                z += @scale * @c1 * RK4_pent(@f1 * z, @scale * @c1);
            else if (@Type1 == 3)
                z += @scale * @c1 * RK4_round(@f1 * z, @N1, @roundShift1, @scale * @c1);
            if (@Type2 == 0)
                ...
                z += @scale * @c2 * RK4_round(@f2 * z, @N2, @roundShift2, @scale * @c2);
            if (@Type3 == 0)
                ...
                z += @scale * @c3 * RK4_round(@f3 * z, @N3, @roundShift3, @scale * @c3);
        }
__bailout:
