...
int main(int, char**)
{
    ...
    const std::string mainTitle = "Lincatëa";
    glfwWindowHint(GLFW_OPENGL_DEBUG_CONTEXT, GL_TRUE);
    GLFWwindow* window = glfwCreateWindow(1280, 720, reinterpret_cast<const char*>(u8"Lincatëa"), NULL, NULL);
    if (window == NULL)
        return 1;
    ...
    ImFont* font_mono = io.Fonts->AddFontFromFileTTF("DroidSansMono.ttf", 18.f);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        mainView::mainViewPort(font_mono);
